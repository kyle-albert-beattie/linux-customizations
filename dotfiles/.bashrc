...
# Add a stopwatch and countdown timer function to bash
countdown() {
    start="$(( $(date '+%s') + $1))"
...
# Add another doc2pdf command that uses the internet website instead
doc2pdf_online () {
...
export PATH="$PATH:/home/kyle/.local/lib/python3.12/site-packages/getwallpapers/getwallpapers.py"
export PATH="$PATH:/bin/markdown"
export PATH="$PATH:/usr/local/bin/bash_scripts"
#export PATH="$PATH:/root/.local/bin/radio"
#export PATH="$PATH:/root/.local/bin/radioactive"
export PATH="$PATH:/home/kyle/Downloads"
export PATH="$PATH:/home/kyle/bin"
export PATH="$PATH:/root/.local/pipx/venvs/gscholar"
...
(cat ~/.cache/wal/sequences &) # This makes wal always put the proper theme in my terminal
