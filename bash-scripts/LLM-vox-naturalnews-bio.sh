...
# Model: Neo-BioMistral-7B-E3-V0-1-5-Q8.gguf
...
llm="/media/kyle/4B/LLMs/LLM-Vox/Neo-BioMistral-7B-E3-V0-1-5-Q8.gguf"
...
# This will play the raw audio outpu from the LLM
