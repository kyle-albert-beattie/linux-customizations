...
# BATCH MONTAGE IMAGE TO PDF
# Author: Kyle Beattie 26-05-2022
# Dependencies: pipx install cairosvg
# Other Dependencies: inkscape, rsvg

# Description:
# This script will convert image files to a montaged PDF as a 2x5 grid of images without losing quality.
...
montage -tile 2x5 -geometry 3052x1576+4+4 -page letter "$(ls -v -- *)" MontagedPDF.pdf
exit 
